...
describe("Tennis", () => {
  ...
  //Cuando ambos jugadores anotan 3 veces --> "Deuce"
  it("deberia mostrar Deuce cuando ambos jugadores anotan tres veces", () => {
    let tennis =new Tennis();
    tennis.jugador1_anota();
    tennis.jugador1_anota();
    tennis.jugador1_anota();
  ...
  //Cuando jugador 1 anota 4 veces y jugador 2 anota 3 veces --> "Advantage for Player 1"
  it("deberia mostrar Advantage for Player 1 cuando jugador 1 anota cuatro veces y jugador 2 tres veces", () => {
    let tennis =new Tennis();
    tennis.jugador1_anota();
    tennis.jugador1_anota();
    tennis.jugador1_anota();
  ...
  //Cuando jugador 1 anota 3 veces y jugador 2 anota 4 veces --> "Advantage for Player 2"
  it("deberia mostrar Advantage for Player 2 cuando jugador 1 anota tres veces y jugador 2 cuatro veces", () => {
    let tennis =new Tennis();
    tennis.jugador1_anota();
    tennis.jugador1_anota();
    tennis.jugador1_anota();
  ...
  //Cuando estan en Deuce y jugador 1 anota dos veces seguidas --> "Game for Player 1"
  it("deberia mostrar Game for Player 1 cuando desde Deuce jugador 1 anota dos veces seguidas", () => {
    let tennis =new Tennis();
    tennis.jugador1_anota();
    tennis.jugador1_anota();
    tennis.jugador1_anota();
